...
is
begin
    open cur for select u.nombre_usuario,c.nombre_cargo,u.correo_usuario,u.usuario_vigente,u.fecha_sesion_usuario from usuario u, cargo c where u.id_cargo = c.id_cargo and correo_usuario = v_correo and contrasena_usuario = v_contrasena and u.usuario_vigente = '1';
    update usuario 
