...
urlpatterns = [
    ...
    path('subasta_venta/<str:id_venta>',SubastaVentaView.as_view(),name='subasta_venta'),
    path('subasta_aceptar/',SubastaAceptarView.as_view(),name='subasta_aceptar'),
    path('subasta_aceptar/<int:id_subasta>',SubastaAceptarView.as_view(),name='subasta_aceptar'),
